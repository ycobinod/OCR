...
search_url = 'https://127.0.0.1:9200/books/_search'
doc_url = 'https://127.0.0.1:9200/books/_doc'

headers = { "Authorization": "ApiKey TzJuSHBJOEJqUGJjSFFsNFQxTlA6bW1VYXBkUUdTQWFId3FVbFV1TXc4UQ=="}


excel_file = openpyxl.load_workbook("books_list.xlsx")
